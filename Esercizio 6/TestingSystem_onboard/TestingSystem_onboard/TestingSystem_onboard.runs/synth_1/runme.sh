...
HD_PWD='C:/Users/giuse/Documents/Progetti tesina/Esercizio 6/TestingSystem_04_Board/TestingSystem_03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestingSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestingSystem.tcl
