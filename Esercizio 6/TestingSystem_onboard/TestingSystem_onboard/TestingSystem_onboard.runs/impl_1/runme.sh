...
HD_PWD='C:/Users/giuse/Documents/Progetti tesina/Esercizio 6/TestingSystem_04_Board/TestingSystem_03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestingSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestingSystem.tcl -notrace
