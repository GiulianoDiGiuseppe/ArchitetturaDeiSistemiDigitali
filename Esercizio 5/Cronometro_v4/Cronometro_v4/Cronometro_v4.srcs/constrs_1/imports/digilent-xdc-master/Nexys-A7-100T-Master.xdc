...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {clock_in}];100mhz


##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { switch_in[0] }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { switch_in[1] }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]w[0]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { switch_in[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]1]
...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { switch_in[5] }]; #IO_L7N_T1_D10_14 Sch=sw[5]
...
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { ore_en }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { init_en }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
##Buttons
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { reset_in }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn15 
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { set_m }]; #IO_L9P_T1_DQS_14 Sch=btnc
